...
document.write(students[lowestStudent] +" has the lowest score, with " + lowest +".");
console.log(students[lowestStudent] +" has the lowest score, with " + lowest +".")
